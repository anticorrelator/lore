...
[[ -z "$WORKTREE_ID" && -z "$EXECUTION_DIR" ]] || { echo "Worker sessions require ordinary placement; manager trees are for native subagents." >&2; exit 1; }
