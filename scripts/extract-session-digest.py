...
def resolve_knowledge_dir(cwd):
    """Resolve knowledge directory by running resolve-repo.sh."""
    script_path = Path(__file__).parent / 'resolve-repo.sh'
...
def main():
    ...
    try:
        ...
        if not knowledge_dir:
            knowledge_dir = resolve_knowledge_dir(args.cwd)
