...
# Sources: implement-lead | spec-lead | remember | manual | audit | impl-verb
#
# Optional flags:
...
case "$SOURCE" in
  implement-lead|spec-lead|remember|manual|audit|impl-verb) ;;
  *)
    echo "[execution-log] Error: --source must be one of: implement-lead, spec-lead, remember, manual, audit, impl-verb" >&2
    exit 1
    ;;
esac
