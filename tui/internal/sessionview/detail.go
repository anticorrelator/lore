...
func (m DetailModel) View() string {
	...
	case !r.Local:
		...
		b.WriteString("\n")
		if r.Tmux != "" {
			b.WriteString(style.Dim.Render("live drill-in available — Enter opens the remote tmux pane"))
		} else {
			b.WriteString(style.Dim.Render("live screen unavailable — tmux identity unknown"))
		}
	}
	b.WriteString("\n\n")
